import cv2
from ultralytics import YOLO             #URL- https://youtu.be/EPKWu223XEg
...
def load_parking_spaces():
    if os.path.exists('parking_spaces3.json'):
        with open('parking_spaces3.json', 'r') as f:
...
def save_parking_spaces():
    ...
    with open('parking_spaces3.json', 'w') as f:
