import cv2
from ultralytics import YOLO             #URL- https://youtu.be/_1PfF1v9GJc
...
def load_parking_spaces():
    if os.path.exists('parking_spaces1.json'):
        with open('parking_spaces1.json', 'r') as f:
...
def save_parking_spaces():
    ...
    with open('parking_spaces1.json', 'w') as f:
